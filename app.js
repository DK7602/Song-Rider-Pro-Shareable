...
style.textContent = `
  ...
  @media (max-width: 390px){
    ...
    #capoStepToggle{ width:21px !important; min-width:21px !important; }
  }
  ...
  @media (min-width: 391px) and (max-width: 520px){
    ...
    #capoInput{ width:38px !important; min-width:38px !important; max-width:38px !important; }
    #keyOutput{ width:40px !important; min-width:40px !important; max-width:40px !important; }
    #capoStepToggle{ width:21px !important; min-width:21px !important; height:30px !important; font-size:9px !important; }
  }

  @media (min-width: 700px){
    #topControlsRow{ gap:6px !important; justify-content:flex-start !important; }
    .miniIconBtn{ width:34px !important; min-width:34px !important; height:34px !important; font-size:16px !important; }
    ...
    #capoStepToggle{ width:26px !important; min-width:26px !important; height:34px !important; font-size:11px !important; }
  }
`;  document.head.appendChild(style);
}
