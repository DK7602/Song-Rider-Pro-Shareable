...
style.textContent = `
  ...
  @media (max-width: 390px){
    #topControlsRow{ gap:3px !important; }
    .miniIconBtn{ width:30px !important; height:30px !important; font-size:13px !important; }
    .tinyCombo{ gap:3px !important; padding:0 5px !important; height:30px !important; }
    .tinyCombo .tinyLbl{ font-size:8px !important; letter-spacing:0 !important; }
    #bpmInput{ width:30px !important; min-width:30px !important; max-width:30px !important; height:28px !important; font-size:12px !important; }
    #capoInput{ width:40px !important; min-width:40px !important; max-width:40px !important; padding:5px 3px !important; font-size:11px !important; }
    #keyOutput{ width:42px !important; min-width:42px !important; max-width:42px !important; font-size:11px !important; }
    #capoStepToggle{ width:22px !important; height:30px !important; font-size:9px !important; }
    #cloudSyncBtn{ font-size:12px !important; }
  }
  ...
  @media (max-width: 360px){
    ...
    #keyOutput{ width:40px !important; min-width:40px !important; max-width:40px !important; }
