...
function chordTrackerLoop(){
  ...
  try{
    ...
    if(analyser){
      ...
      // Use ONLY the dedicated root-first chord-tracker.js engine for live detection.
      // The older in-app FFT fallback is disabled because it is the part that
      // guesses relative/wrong chords such as G -> Em, C -> Am, and D -> F.
      let det = null;
