...
style.textContent = `
  ...
  .tinyField.key{ flex:1 1 auto !important; min-width:0 !important; }
  .miniIconBtn{
  ...
  @media (max-width: 390px){
    #topControlsRow{ padding-left:8px !important; padding-right:8px !important; }
    #capoStepWrap{ gap:3px !important; }
    .tinyField.key{ flex:1 1 44px !important; }
  }

  @media (min-width: 391px) and (max-width: 520px){
    #topControlsRow{ padding-right:6px !important; }
    .tinyField.key{ flex:1 1 58px !important; }
  }
