...
function updateKeyFromAllNotes(){
  // ✅ Key detection is based primarily on CHORDS in the 4 beat boxes,
  // with a light contribution from any melody notes in the 8 note boxes.
  ...
  // If nothing at all, show em dash
